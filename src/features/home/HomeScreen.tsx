...
export const HomeScreen = ({
  ...
  const allVisibleSelected =
    ...
    visibleBulkIds.length > 0 &&
    visibleBulkIds.every((id) => selectedBulkIds.has(id));
  ...
  }, [homeView, visibleBulkIds.length]);
  ...
  const toggleAllVisible = useCallback(() => {
    setSelectedBulkIds(
      allVisibleSelected ? new Set() : new Set(visibleBulkIds),
    );
    void runHapticsSafely(() => Haptics.selectionAsync());
  }, [allVisibleSelected, visibleBulkIds]);
